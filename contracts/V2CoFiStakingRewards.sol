...
contract V2CoFiStakingRewards is ICoFiStakingRewards, ReentrancyGuard {
    ...
    function getReward() public override nonReentrant updateReward(msg.sender) {
        ...
        if (pendingSavingAmount > 0) {
            address _to = ICoFiXV2Factory(factory).getDAO();
            ...
            ICoFiXV2DAO(_to).addETHReward{value: _amount}();
