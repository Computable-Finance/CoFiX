...
contract CoFiXDAO is ICoFiXDAO, ReentrancyGuard {
    ...
    {  
        ...
        ICoFiToken(cofiToken).approve(cofiStaking, uint(-1));
    ...
    function migrateTo(address _newDAO) external onlyGovernance
    {
        ...
        ICoFiXDAO(_newDAO).addETHReward{value: ethBalance}();
        ethBalance = 0;
        ...
        external payable nonReentrant whenActive
    {
        ...
        uint256 price;
        {
            ...
            (uint256 ethAmount, uint256 tokenAmount, uint256 avg, ) = ICoFiXController04(ICoFiXFactory02(factory).getController())
