...
interface ICoFiXVaultForTrader02 {
    ...
    function calcNeededETHAmountForAdjustment(address pair, uint256 ethAmount, uint256 erc20Amount) external view returns (uint256);

    function actualMiningAmount(address pair, uint256 ethAmount, uint256 erc20Amount) external view returns (uint256 amount, uint256 totalAccruedAmount, uint256 neededETHAmount);
