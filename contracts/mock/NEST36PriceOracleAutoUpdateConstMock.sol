...
contract NEST36PriceOracleAutoUpdateConstMock {
    ...
    function latestPrice(address token)
        ...
        returns (
            ...
            uint triggeredSigmaSQ )
    {
        return (block.number - 5, priceInfoMap[token].latestPriceValue, block.number - 5, priceInfoMap[token].triggeredPriceValue, priceInfoMap[token].triggeredAvgPrice, priceInfoMap[token].triggeredSigmaSQ);
    }
