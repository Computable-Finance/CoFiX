...
const CoFiXVaultForTrader = artifacts.require("CoFiXVaultForTrader02");
...
contract('CoFiXVaultForTrader', (accounts) => {
    ...
    it("should have correct current stats before anything", async () => {
        ...
        const neededETHAmount = await VaultForTrader.calcNeededETHAmountForAdjustment(pair, ethAmount, erc20Amount);
        ...
        const res = await VaultForTrader.actualMiningAmount(pair, ethAmount, erc20Amount);
        if (verbose) {
