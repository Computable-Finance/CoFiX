...
contract CoFiXStakingRewards02 is ICoFiXStakingRewards, ReentrancyGuard {
    ...
    constructor(
        ...
        require(ICoFiXFactory02(_factory).getVaultForLP() != address(0), "VaultForLP not set yet"); // check
        factory = _factory;
    ...
    function rewardsVault() public virtual override view returns (address) {
        return ICoFiXFactory02(factory).getVaultForLP();
    }
